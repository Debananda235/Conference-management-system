...
namespace Database_Project
{
    public partial class UpdateAuthorForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            c.Connection = conn;
            c.CommandText = "update AUTHORS set Email=:Email, Password=:Password where UserName =:Username";
            c.Parameters.Add("Email",    textBox4.Text);
            c.Parameters.Add("Password", textBox5.Text);
            c.Parameters.Add("Username", textBox3.Text);
            int r = c.ExecuteNonQuery();
            if (r != -1)
            {
                MessageBox.Show("Author is modified");
            }
        }
